...
public class HighestCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        player.sendMessage(Util.PREFIX_COLOR +
                ...
                Util.DEFAULT_COLOR +
                " Highest Item Percentage Changes");
        ...
        for (String item : changes.keySet()) {
            ...
            player.sendMessage(Util.HIGHLIGHT_COLOR + String.valueOf(place) + ") " + Util.DEFAULT_COLOR + item.toLowerCase() +
                    " " + color + "(" + sign + String.format("%.2f%%", Math.abs(1 - changes.get(item))) + ")");
